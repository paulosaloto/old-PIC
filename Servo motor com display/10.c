...
int hora=0, minutos=0, segundos=0, dia =0, mes =0, ano =0, data =0, resto=0, horario=0, aux_timer=0, posicao=0, quantidade=0;
...
void Define_referencia(int faixa)
{
   ...
   switch(faixa)
   {
      ...
      case(2):
      valor_aux = 0.0026*angulo_pedido*angulo_pedido*_pedido - 0.627*angulo_pedido*angulo_pedido + 51.567*angulo_pedido - 935.34; //Esse é double, então o número é "quebrado"
      kp=10;
      break;
