...
unsigned int interrupcao=0,int_anterior, i, flag;
unsigned long int sobe, desce, distancia, teste;
//variaveis da comunicação serial
int checksum_tx, x=0, y=0, z=0;
...
void receber()
{  
   if(48+checksum_tx!=getchar())
   {
      printf(lcd_putc,"FALHA NA \nCOMUNICAÇÃO");
   }
...
////////////////////////////////////////////////////////////////////////////////
   ...
   set_tris_a(0x00); // Define que somente 1 via do PIC será entrada.
   set_tris_b(0xF8); //
   set_tris_c(0x8F); //
   set_tris_d(0x00); //
...
////////////////////////////////////////////////////////////////////////////////
////               CONFIGURAÇÃO DAS INTERRUPÇÕES DO CCP 1 E 2               ////
////////////////////////////////////////////////////////////////////////////////     
   ...
   delay_ms(3000);
   printf(lcd_putc,"\ftmr1:    dist:");
   bit_set(porta,1);
   delay_us(4);  
   bit_clear(porta,1);           
   set_timer1(0);   //ver se tá no lugar certo
   set_tris_a(0x02);
   flag=1;
   //delay_ms(1000) ;
...
////////////////////////////////////////////////////////////////////////////////         
   while(1)
   {
      ...
      if (flag==1)
      {
         ...
         angulo_pedido=distancia;
         printf(lcd_putc,"\n%05lu    %03lu  ",(desce-sobe),distancia);
         EnviaAngulo();
         flag=0;
         delay_ms(30);
         y++;
