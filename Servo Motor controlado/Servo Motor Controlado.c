...
//Variáveis usadas pelas interrupções//
int angulo_pedido;
int angulo_pedido_anterior;
long int valor_pot;

//Fim das váriaveis usadas pelas interrupções//

//Interrupção do teclado
/*
interrupt_teclado()
{
angulo_pedido = ? //Aqui tem que entrar o seu valor entre 0 e 180º
}
*/
